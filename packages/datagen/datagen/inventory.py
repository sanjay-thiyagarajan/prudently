...
CATALOG = [
    # (sku, name, category, unit, baseline_daily_consumption)
    ("N95-001", "N95 respirator masks", "PPE", "box-of-20", 12),
    ("GLV-002", "Nitrile exam gloves", "PPE", "box-of-100", 8),
    ("IVF-003", "IV saline fluid bags", "fluids", "bag", 40),
    ("OSE-004", "Oseltamivir (antiviral)", "pharmacy", "course", 3),
    ("ABX-005", "Broad-spectrum antibiotics", "pharmacy", "course", 6),
    ("O2-006", "Oxygen cylinders", "respiratory", "cylinder", 5),
    ("SYR-007", "Syringes", "consumables", "box-of-100", 6),
    ("GWN-008", "Isolation gowns", "PPE", "box-of-10", 5),
]
...
def generate_inventory(seed: int) -> tuple[list[InventoryItem], list[Vendor]]:
    ...
    for sku, name, category, unit, daily in CATALOG:
