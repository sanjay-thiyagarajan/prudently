...
| **Medical Representative** | External-facing vendor/pharma liaison; owns the Model Armor "poisoned vendor email" demo moment; talks to Supply Chain via genuine **Agent2Agent**, not the internal Gateway | **Deployed & verified, Aug 21** (Model Armor screening only — A2A wiring to Supply Chain is Day 5) |
